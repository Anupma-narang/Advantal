...
<div>
  ...
  <script type="text/javascript">
    $('#save').click(function(){
      gmapSample_AddConsoleLine('map bounds:'+map.getBounds());
      gmapSample_AddConsoleLine('map zoom:'+map.getZoom());
      gmapSample_AddConsoleLine('marker position:'+marker.getPosition());
