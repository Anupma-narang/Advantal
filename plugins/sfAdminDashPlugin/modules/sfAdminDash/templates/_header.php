...
<?php if ($sf_user->isAuthenticated()): ?> 
  ...
  <div id='sf_admin_menu'>    
    ...
    <?php if (sfAdminDash::getProperty('logout') && $sf_user->isAuthenticated()): ?>
      <div id="logout"><?php echo link_to(__('Salir', null, 'sf_admin_dash'), sfAdminDash::getProperty('logout_route', '@sf_guard_signout ')); ?> <?php echo $sf_user; ?></div>
    <?php endif; ?>
    <div class="clear"></div>
  </div>
  ...
  <?php if (sfAdminDash::getProperty('include_path')): ?>
    <div id='sf_admin_path'>
      ...
      <?php if ($sf_context->getModuleName() != 'sfAdminDash' && $sf_context->getActionName() != 'dashboard'): ?>
        / <?php echo null !== $module_link ? link_to(str_replace("_"," ",$module_link_name), $module_link) : str_replace("_"," ",$module_link_name); ?>
        <?php if (null != $action_link): ?>
          / <?php echo link_to(__(str_replace("_"," ",strtolower($action_link_name)), null, 'sf_admin'), $action_link); ?>
        <?php endif ?>
      <?php endif; ?>
    </div>
  <?php endif; ?>
