...
<div id="ctr" align="center">
  <div class="login">
        ...
        <div class="form-block">
          ...
          <?php if(isset($form['_csrf_token'])): ?>
            <?php echo $form['_csrf_token']->render(); ?> 
			    <?php endif; ?>
          <div class="inputlabel"><?php echo $form['username']->renderLabel(__('E-Mail', array(), 'sf_admin_dash')); ?></div>
          <div>
    ...
    <div class="login-text">
      ...
      <p><?php echo __('Usa un nombre de usuario y contraseña válidos para entrar al administrador.', array(), 'sf_admin_dash'); ?></p>
    </div>
