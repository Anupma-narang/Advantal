...
{	
  public function configure($options = array(), $messages = array())
  {
    ...
    $this->setMessage('invalid', 'Ese correo electrónico y/o contraseña no son válidos.');
  }
  ...
  {    
    ...
    /*if($password==''){
    	$no_pass= new sfValidatorError($this, 'Debes introducir una contraseña.');
    	//throw new sfValidatorErrorSchema($this, array($this->getOption('password_field') => $no_pass));
    }*/
