 ...
 */
class audWidgetFormJQueryAutocompleterInField extends sfWidgetFormInput
{
    /**
    ...
    public function render($name, $value = null, $attributes = array(), $errors = array())
    {
        ...
        if ($this->hasOption('depends')) {
//            $url .= '&' . $this->getOption('depends') . '=%%VALUE%%';
        }
...
EOF
                ,
                $url,
                $this->hasOption('depends'),
                strstr($this->generateId($name), $name, true) . $this->getOption('depends'),
