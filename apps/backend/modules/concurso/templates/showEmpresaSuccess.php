    ...
    <div id="sf_admin_content">        
        ...
        <?php if ($concurso->concurso_estado_id == 4): // Deliberación   ?>
            ...
            <?php if (count($results)): ?>
                ...
                <span class="prev" title="Anterior">
                  <a href="javascript:void(0);"><?php echo image_tag('/images/previous.png', array('title' => 'Siguiente')); ?></a>
                </span>&nbsp;
                <span class="next" title="Siguiente">
                  <a href="javascript:void(0);"><?php echo image_tag('/images/next.png', array('title' => 'Último')); ?></a>
                </span>
            <?php endif; ?>
        <?php endif; ?>
